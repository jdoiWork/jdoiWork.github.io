...
Elm.Native.Array.make = function(localRuntime) {
  ...
  function toList_(list, a) {
    for (var i = a.table.length - 1; i >= 0; i--) {
      list =
        a.height === 0 ? List.Cons(a.table[i], list) : toList_(list, a.table[i]);
    }
    return list;
  }
  ...
  function map(f, a) {
    ...
    for (var i = 0; i < a.table.length; i++) {
      newA.table[i] =
        a.height === 0 ? f(a.table[i]) : map(f, a.table[i]);
    }
    return newA;
  }
  ...
  function indexedMap_(f, a, from) {
    ...
    for (var i = 0; i < a.table.length; i++) {
      newA.table[i] =
        a.height === 0 ? A2(f, from + i, a.table[i]) : indexedMap_(f, a.table[i], i == 0 ? from : from + a.lengths[i - 1]);
    }
    return newA;
  }
...
Elm.Basics.make = function(_elm) {
  ...
  var snd = function(_p2) {
    var _p3 = _p2;
    return _p3._1;
  };
  var fst = function(_p4) {
    var _p5 = _p4;
    return _p5._0;
  };
  var always = F2(function(a, _p6) {
    return a;
  });
...
Elm.Native.Graphics.Collage.make = function(localRuntime) {
  ...
  function setStrokeStyle(ctx, style) {
    ...
    ctx.lineCap = cap === 'Flat' ? 'butt' : cap === 'Round' ? 'round' : 'square';

    var join = style.join.ctor;
    ctx.lineJoin = join === 'Smooth' ? 'round' : join === 'Sharp' ? 'miter' : 'bevel';
  ...
  function setFillStyle(redo, ctx, style) {
    var sty = style.ctor;
    ctx.fillStyle = sty === 'Solid' ? Color.toCss(style._0) : sty === 'Texture' ? texture(redo, ctx, style._0) : gradient(ctx, style._0);
  }
  ...
  function nodeStepper(w, h, div) {
    ...
    function addElement(matrices, alpha, form) {
      ...
      var node = (!kid || kid.getContext) ? NativeElement.render(elem) : NativeElement.update(kid, kid.oldElement, elem);
...
Elm.Native.Graphics.Element.make = function(localRuntime) {
  ...
  function toPos(pos) {
    return pos.ctor === 'Absolute' ? pos._0 + 'px' : (pos._0 * 100) + '%';
  }
  ...
  function update(node, wrappedCurrent, wrappedNext) {
    ...
    switch (nextE.ctor) {
      ...
      case 'Image':
        ...
        } else if (!Utils.eq(nextE, currE) || next.props.width !== curr.props.width || next.props.height !== curr.props.height) {
          return render(wrappedNext);
        }
        updateProps(node, curr, next);
        return rootNode;
  ...
  function updateProps(node, curr, next) {
    ...
    var nextColor = nextProps.color.ctor === 'Just' ? Color.toCss(nextProps.color._0) : '';
    ...
    if (removed && nextProps.hover.ctor === '_Tuple0' && nextProps.click.ctor === '_Tuple0') {
  ...
  var htmlHeight =
    typeof document !== 'undefined' ? realHtmlHeight : function(a, b) {
...
Elm.Native.Text.make = function(localRuntime) {
  ...
  function toLine(line) {
    var ctor = line.ctor;
    return ctor === 'Under' ? 'underline' : ctor === 'Over' ? 'overline' : 'line-through';
  }
...
Elm.Graphics.Element.make = function(_elm) {
  ...
  var midLeft = Position({
    horizontal: N,
    vertical: Z,
    x: Absolute(0),
    y: Relative(0.5)
  });
  var midBottom = Position({
    horizontal: Z,
    vertical: N,
    x: Relative(0.5),
    y: Absolute(0)
  ...
  var color = F2(function(clr, _p19) {
    ...
    return Element_elm_builtin({
      ...
      props: _U.update(_p20._0.props, {
        color: $Maybe.Just(clr)
      })
    });
  });
...
Elm.Graphics.Collage.make = function(_elm) {
  ...
  var moveX = F2(function(x, _p11) {
    var _p12 = _p11;
    var _p13 = _p12._0;
    return Form_elm_builtin(_U.update(_p13, {
      x: _p13.x + x
    }));
  });
  var moveY = F2(function(y, _p14) {
    var _p15 = _p14;
    var _p16 = _p15._0;
    return Form_elm_builtin(_U.update(_p16, {
      y: _p16.y + y
    }));
  });
  ...
  var alpha = F2(function(a, _p23) {
    var _p24 = _p23;
    return Form_elm_builtin(_U.update(_p24._0, {
      alpha: a
    }));
  });
  return _elm.Graphics.Collage.values = {
  ...
  function stepTask(onComplete, root, task) {
    ...
    if (tag === 'AndThen' || tag === 'Catch') {
      ...
      if (result.status === 'done') {
        ...
        return (succeedChain || failChain) ? mark('runnable', task.callback(activeTask.value)) : mark('runnable', activeTask);
      }
      if (result.status === 'blocked') {
        return mark('blocked', {
          tag: tag,
...
Elm.Dict.make = function(_elm) {
  ...
  var reportRemBug = F4(function(msg, c, lgot, rgot) {
    return $Native$Debug.crash($String.concat(_U.list(["Internal red-black tree invariant violated, expected ", msg, " and got ", $Basics.toString(c), "/", lgot, "/", rgot, "\nPlease report this bug to <https://github.com/elm-lang/core/issues>"])));
  });
  ...
  var sizeHelp = F2(function(n, dict) {
    sizeHelp: while (true) {
      ...
      if (_p3.ctor === "RBEmpty_elm_builtin") {
        ...
        var _v10 = A2(sizeHelp, n + 1, _p3._4),
          _v11 = _p3._3;
        n = _v10;
        dict = _v11;
        continue sizeHelp;
...
Elm.Native.Effects.make = function(localRuntime) {
  ...
  function send(time) {
    for (var i = messageArray.length; i--;) {
      var messages = A3(
        List.foldl,
        F2(function(toAction, list) {
          return List.Cons(toAction(time), list);
        }),
        List.Nil,
...
Elm.Effects.make = function(_elm) {
  ...
  var ignore = function(task) {
    return A2($Task.map, $Basics.always({
      ctor: "_Tuple0"
    }), task);
  };
  ...
  23: [function(require, module, exports) {
    ...
    Elm.Native.VirtualDom.make = function(elm) {
      ...
      function makeNode(name, propertyList, contents) {
        ...
        var useSoftSet =
          (name === 'input' || name === 'textarea') && props.value !== undefined && !isHook(props.value);
    ...
    return Task.asyncFunction(function(callback) {
      ...
      if (settings.onProgress.ctor === 'Just') {
        req.addEventListener('progress', function(event) {
          var progress = !event.lengthComputable ? Maybe.Nothing : Maybe.Just({
            _: {},
            loaded: event.loaded,
            total: event.total
          });
...
Elm.Http.make = function(_elm) {
  ...
  var TODO_implement_file_in_another_library = {
    ctor: "TODO_implement_file_in_another_library"
  };
  var TODO_implement_blob_in_another_library = {
    ctor: "TODO_implement_blob_in_another_library"
  };
...
Elm.StartApp.make = function(_elm) {
  ...
  var start = function(config) {
    ...
    return {
      html: A2($Signal.map, config.view(address), model),
      model: model,
      tasks: A2($Signal.map,
        function(_p5) {
...
Elm.About.make = function(_elm) {
  ...
  var view = function(items) {
    return A2($Html.main$,
      ...
      _U.list([A2($Html.h1,
        ...
        _U.list([$Html.text("jdoi.pw")])), A2($Html.ul,
  ...
  var About = F2(function(a, b) {
    return {
      title: a,
      url: b
    };
  });
  var aboutDecoder = A3($Json$Decode.object2,
    About,
