(function(scope) {
  ...
  */
  ...
  var author$project$About$Response = function(a) {
    return {
      $: 'Response',
      a: a
    };
  };
  var author$project$About$About = F2(
    function(title, url) {
      return {
        title: title,
        url: url
  ...
  var author$project$About$aboutDecoder = A3(
    elm$json$Json$Decode$map2,
    author$project$About$About,
  ...
  var author$project$About$decoder = A2(
    elm$json$Json$Decode$at,
    _List_fromArray(
      ['about']),
    elm$json$Json$Decode$list(author$project$About$aboutDecoder));
  ...
  var author$project$About$update = F2(
    function(msg, model) {
      if (msg.$ === 'Request') {
        return _Utils_Tuple2(_List_Nil, author$project$About$getItems);
      } else {
        var result = msg.a;
        if (result.$ === 'Ok') {
          var items = result.a;
          return _Utils_Tuple2(items, elm$core$Platform$Cmd$none);
        } else {
  ...
  var author$project$About$jumpTo = function(item) {
    return A2(
      elm$html$Html$li,
      _List_Nil,
      _List_fromArray(
            ...
            _List_fromArray(
              [
                A2(
                  ...
                  _List_fromArray(
                    [
                      elm$html$Html$Attributes$class('trademark')
                    ]),
                  _List_Nil),
                A2(
                  elm$html$Html$span,
      ...
      _List_fromArray(
        [
          A2(
            ...
            _List_fromArray(
              [
                elm$html$Html$Attributes$id('home-logo')
              ]),
            _List_fromArray(
              [
